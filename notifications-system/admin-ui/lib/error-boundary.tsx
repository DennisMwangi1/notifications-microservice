...
/**
 * React Error Boundary for graceful failure handling in the Admin UI.
...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
    ...
    render() {
        if (this.state.hasError) {
            ...
            return (
                <div className="max-w-md mx-auto mt-20 text-center p-8 bg-white border border-neutral-200 rounded-2xl shadow-sm">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-neutral-900 hover:bg-neutral-800 text-white rounded-xl text-sm font-semibold transition-colors"
                    >
                        Try Again
                    </button>
                </div>
